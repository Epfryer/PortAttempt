    ...
    <>
            ...
            >
              ...
              >
                {content.map((item, index) => (
                  ...
                  >
                    <div className="max-w-7xl w-full grid grid-cols-[minmax(200px,25%),1fr] gap-4">
      ...
      {isExpanded && (
        <motion.div 
          ...
          exit={{ opacity: 0 }}
        >
          {/* The horizontal carousel content… */}
          <ProjectCarousel projects={project.relatedProjects} />
        </motion.div>
      )}
    </>
  );
